...
class Evaluation:
    ...
    def evaluate(self):
        ...
        with torch.no_grad():        
            ...
            f.write('acc@1: ' + str(formatter.format(recall1/iter_cnt)))
            f.write('\n')
            print('recall@5:', formatter.format(recall5/iter_cnt))
            f.write('acc@5: ' + str(formatter.format(recall5/iter_cnt)))
            f.write('\n')
            print('recall@10:', formatter.format(recall10/iter_cnt))
            f.write('acc@10: ' + str(formatter.format(recall10/iter_cnt)))
            f.write('\n')
            print('MAP', formatter.format(average_precision/iter_cnt))
            f.write('MAP ' + str(formatter.format(average_precision/iter_cnt)))
            f.write('\n')
